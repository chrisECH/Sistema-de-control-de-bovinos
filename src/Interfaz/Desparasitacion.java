...
public class Desparasitacion extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Registrar Desparasitacion.");
    ...
    private void btnCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelarActionPerformed
        ...
        int resultado = JOptionPane.showConfirmDialog(null, "¿Desea cancelar el registro de desparasitación?", "Exit", dialogo);
        if (resultado == 0) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Desparasitacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void Registrar() {
        try{String arete = jtxAreteCria.getText(); //Obtiene el arete ingresado para poder validar que esta registrado
            ...
            if(valido.equals(arete)){//Si esta registrada procede con el registro
                ...
                boolean respuesta = obj.Desparasitacion(arete, fecha, tratamiento); //Se manda llamar al Metodo Desparasitacion y se le envian las cadenas antes mensionadas,
                ...
                if(res.equals("true")){ //Si la respuesta de la sentencia es igual a True, entonces se registro correctamente la vacunación
                    JOptionPane.showMessageDialog(null, "Desparasitación registrada correctamente.", "Ok.", JOptionPane.INFORMATION_MESSAGE); //Mensaje al usuario de que se ha registrado exitosamente.
                    ...
                    //////////////////////////////////////////////////////////////////////////////////////////////////////////////
                }else{ //Si hubo un error entonces se manda un mensaje de que no se registro la vacunación
                    JOptionPane.showMessageDialog(null, "No se pudo registrar la desparasitación.", "Warning.", JOptionPane.WARNING_MESSAGE); //Mensaje al usuario de que no se registro 
                }
