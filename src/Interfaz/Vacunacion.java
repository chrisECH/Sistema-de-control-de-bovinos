...
public class Vacunacion extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Registrar Vacunación.");
    ...
    private void btnCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelarActionPerformed
        ...
        int resultado = JOptionPane.showConfirmDialog(null, "¿Desea cancelar el registro de vacunación?", "Exit", dialogo);
        if (resultado == 0) {
    ...
    private void Registrar() {
        try {
            ...
            if(valido.equals(arete)){//Si esta registrada procede con el registro
                ...
                boolean respuesta = obj.Vacunacion(arete, fecha, tratamiento); //Se manda llamar al Metodo Vacunacion y se le envian las cadenas antes mensionadas,
                ...
                if(res.equals("true")){ //Si la respuesta de la sentencia es igual a True, entonces se registro correctamente la vacunación
                    JOptionPane.showMessageDialog(null, "Vacunación registrada correctamente.", "Ok.", JOptionPane.INFORMATION_MESSAGE); //Mensaje al usuario de que se ha registrado exitosamente.
        ...
        } catch (Exception e) { //Si hay algun error se mostrara en forma de mensaje al usuario
