 ...
 * @author dell1
 */
public class Descorne extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jBoxDescorne = new javax.swing.JComboBox<>();
        ...
        jLabel4.setText("Registrar Descorne.");
        ...
        jLabel5.setText("Tipo de descorne:");

        jBoxDescorne.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Pasta", "Sierra", "Quirurgica" }));
        jBoxDescorne.setSelectedIndex(-1);
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jBoxDescorne, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(50, 50, 50)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel5)
                    .addComponent(jBoxDescorne, javax.swing.GroupLayout.DEFAULT_SIZE, 32, Short.MAX_VALUE))
                .addGap(18, 18, 18)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel3)
    ...
    private void btnCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelarActionPerformed
        ...
        int resultado = JOptionPane.showConfirmDialog(null, "¿Desea cancelar el registro de descorne?", "Exit", dialogo);
        if (resultado == 0) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Descorne.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JComboBox<String> jBoxDescorne;
    ...
    private void Registrar() {
        try{String arete = jtxAreteCria.getText(); //Obtiene el arete ingresado para poder validar que esta registrado
            ...
            if(valido.equals(arete)){//Si esta registrada procede con el registro
                ...
                String tipo = jBoxDescorne.getSelectedItem().toString();
                
                 Manejador obj = new Manejador(); //Se vuelve a llamar al manejador, esto para no confundir lo que se va a hacer en cada caso.
                
                boolean respuesta = obj.Descorne(arete, fecha,tipo, tratamiento); //Se manda llamar al Metodo Descorne se le envian las cadenas antes mensionadas,
                ...
                if(res.equals("true")){ //Si la respuesta de la sentencia es igual a True, entonces se registro correctamente el descorne
                    JOptionPane.showMessageDialog(null, "Descorne registrado correctamente.", "Ok.", JOptionPane.INFORMATION_MESSAGE); //Mensaje al usuario de que se ha registrado exitosamente.
                    ...
                    //////////////////////////////////////////////////////////////////////////////////////////////////////////////
                }else{ //Si hubo un error entonces se manda un mensaje de que no se registro el descorne
                    JOptionPane.showMessageDialog(null, "No se pudo registrar el descorne.", "Warning.", JOptionPane.WARNING_MESSAGE); //Mensaje al usuario de que no se registro 
                }
